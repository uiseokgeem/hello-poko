...
import { Form, Input, Select, Radio, Button, Typography, Checkbox } from "antd";
      ...
      <div className="form-wrapper">
        ...
        <Form layout="vertical" form={form} onFinish={handleSubmit}>
          ...
          {students.map((student) => (
            <div key={student.id} style={{ marginBottom: "16px", padding: "12px", border: "1px solid #eee", borderRadius: 8 }}>
              <strong>{student.name}</strong>
              <Form.Item name={["students", student.id, "attendedWorship"]} label="예배 참석">
                <Checkbox />
              </Form.Item>
              <Form.Item name={["students", student.id, "attendedGqs"]} label="GQS 참석">
                <Checkbox />
              </Form.Item>
              <Form.Item name={["students", student.id, "careNote"]} label="세부 내용">
...
//           <Form.Item name="conversation" label="목양일지 세부내용">
